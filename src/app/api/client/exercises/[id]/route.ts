  ...
  try {
    ...
    return NextResponse.json({
      exercise: {
        ...
        instructions_secondary: exercise.instructions_secondary,
        common_mistakes: exercise.common_mistakes,
        common_mistakes_secondary: exercise.common_mistakes_secondary,
        ...
        regressions_secondary: exercise.regressions_secondary,
        progressions: exercise.progressions,
        progressions_secondary: exercise.progressions_secondary,
      },
